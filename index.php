...
<div class="wrapper">
         ...
         <?php 
          if ($result) {
            ...
            <!-- Box Comment -->
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href=" blogdetail.php?id=<?php echo $value['id'];?>"><img src="admin/images/<?php echo $value['image'] ?>"class="container-fluid" style="height: 350px  !important;"></a>
  ...
  <footer class="main-footer" style="margin-left: 0px !important">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020-2021 <a href="https://adminlte.io">ThinzarNwe</a>.</strong> All rights reserved.
  </footer>
